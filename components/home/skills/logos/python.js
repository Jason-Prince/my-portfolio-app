const python = () => {
  return (
    <svg
      ...
      enable-background="new 0 0 2080 2325.5"
      className="svg--size"
    >
      <path
        className="st0"
        d="M227.1,1988.2c0-92.2-26.3-138.2-79-139.9c-21.4-1.6-41.1,3.3-60.9,9.9c-16.5,4.9-26.3,11.5-31.3,16.5v217.2
	...
	c14.8,14.8,23,34.6,23,55.9L1866.1,2152.7z"
      ...
      <linearGradient
        ...
        x2="12991.0264"
        y2="-27073.4023"
        gradientTransform="matrix(9.2563 0 0 -9.3468 -119299.5781 -252400.0313)"
      >
      ...
      <path
        className="st1"
        d="M908.4,0.3c-52.7,0-103.7,4.9-148.1,13.2c-131.6,23-154.7,70.8-154.7,161.3v118.5h309.4v39.5H490.4
	...
	S707.6,94.1,740.5,94.1z"
      ...
      <path
        className="st2"
        d="M1262.2,329.4V466c0,107-90.5,195.8-194.2,195.8H760.3c-83.9,0-154.7,72.4-154.7,158v294.6
	...
	c31.3,0,57.6,26.3,57.6,59.2s-26.3,59.2-57.6,59.2c-31.3,0-57.6-26.3-57.6-59.2S1056.5,1074.9,1087.7,1074.9z"
      ...
      <path
        className="st0"
        d="M1973,1767.7h9.9v-60.9h23v-8.2H1950v8.2h23V1767.7z M2015.8,1767.7h8.2v-55.9l18.1,55.9h9.9l18.1-55.9v55.9
	h9.9v-69.1h-11.5l-21.4,59.2l-18.1-59.2h-13.2L2015.8,1767.7z"
      ...
      <radialGradient
        ...
        cy="-13866.3984"
        r="20.3396"
        gradientTransform="matrix(0 -3.9477 -17.3558 0 -239744.5313 -326357.7188)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <path
        className="st3"
        d="M1332.9,1471.5c0,44.4-185.9,80.6-414.7,80.6s-414.7-36.2-414.7-80.6c0-44.4,185.9-80.6,414.7-80.6
