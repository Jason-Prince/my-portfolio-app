const home = () => {
  return (
    <div className="body">
      <img
        className="body__car body__car--center-fixed"
        src="/car.png"
        alt="car"
      />
      <div className="body__row-1">
        <svg
          className="body__row-1__arizona"
          version="1.1"
